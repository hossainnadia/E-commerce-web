...
const Dashboard = () => {
    ...
    // Dynamic content rendering based on active tab click
    const renderContent = () => {
        switch (activeTab) {
            case 'Overview':
                return (
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 md:p-16 text-center max-w-lg w-full shadow-2xs relative overflow-hidden">
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed max-w-xs mx-auto mt-2">
                            Welcome to your main console. The layout mapping and client-side middleware authorization parameters are fully active.
                        </p>
                    </div>
                );
            case 'Orders':
                return (
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 max-w-2xl w-full shadow-2xs">
                        ...
                        <div className="border-2 border-dashed border-gray-100 rounded-xl p-8 text-center text-xs text-gray-400">
                            No recent orders found. Your shopping cart sync is functional.
                        </div>
                    </div>
                );
            case 'Profile':
                return (
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 max-w-md w-full shadow-2xs">
                        ...
                        <div className="space-y-2 text-xs text-gray-500">
                            <div className="flex justify-between py-2 border-b border-gray-50"><span>Status</span><span className="text-emerald-600 font-semibold">Active</span></div>
                            <div className="flex justify-between py-2"><span>Tier</span><span className="text-indigo-600 font-medium">Premium Member</span></div>
                        </div>
                    </div>
                );
            case 'Settings':
                return (
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 max-w-md w-full shadow-2xs">
                        ...
                        <button className="px-4 py-2 bg-gray-900 text-white text-xs font-semibold rounded-xl hover:bg-gray-800 transition">
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] font-sans text-gray-900 flex flex-col md:flex-row antialiased">
            ...
            <div className="md:hidden bg-[#0b1329] px-6 py-4 flex justify-between items-center shadow-md">
                {/* Logo Match from image_402d65.png */}
            ...
            {/* --- SIDEBAR (Matches top dark accent of image_402d65.png) --- */}
            <div className={`
      ...
      `}>
                            ...
                            return (
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        setIsSidebarOpen(false); // Closes mobile drawer on click
                                    }}
            ...
            <main className="flex-1 p-6 md:p-12 max-w-6xl w-full mx-auto flex flex-col justify-between">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 pb-6 mb-8">
                    <div>
                        ...
                        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-gray-900 mt-2">
                            {activeTab === 'Overview' ? 'Hello, Nadia' : activeTab}
                        </h1>
                        <p className="text-xs text-gray-400 mt-0.5">Manage your personal settings and profile logs seamlessly.</p>
                    </div>

                    <div className="text-left sm:text-right bg-white px-4 py-2 rounded-xl border border-gray-100 shadow-2xs">
                        <span className="text-[10px] text-gray-400 block uppercase font-medium">Account Guard</span>
                ...
                {/* Absolute Bottom Branding Footer */}
